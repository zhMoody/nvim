...
local custom_filetype = require "ui.statusline.components.custom_filetype"
local custom_mode = require "ui.statusline.components.custom_mode"
local custom_file_path =
  require "ui.statusline.components.custom_file_path"
